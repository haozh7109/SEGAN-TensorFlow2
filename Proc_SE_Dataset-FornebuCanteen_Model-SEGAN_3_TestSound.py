...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_clean_data_path', default='/TensorFlowSSD/training_set_canteenFornebu/Data_for_SEGAN/testset_clean', type=str, help='test clean data path')
    parser.add_argument('--test_noisy_data_path', default='/TensorFlowSSD/training_set_canteenFornebu/Data_for_SEGAN/testset_noisy', type=str, help='test noisy data path')
    ...
    parser.add_argument('--output_data_path', default='/TensorFlowSSD/training_set_canteenFornebu/Data_for_SEGAN/output/Inference', type=str, help='output data path')
    ...
    #
    #         generator.load_weights(f'{MODEL_WEIGHTS_SAVE_PATH}/generator_weights_epoch_{epoch + 1}')
    #         print(f'Loaded the model of epoch {epoch+1} successfully!')
    #
    #     else:
    #         break
    ...
    # for idx in range(len(test_NoisyFile_lists)):
    #     # load the clean and noisy data
    #     noisy_sound_file = test_NoisyFile_lists[idx]
    #     clean_sound_file = test_CleanFile_lists[idx]
